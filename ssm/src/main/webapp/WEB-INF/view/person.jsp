...
<body class="gray-bg">
        ...
        <div class="row">
			 ...
			 <div class="col-lg-2">
				<div class="input-group">
			      ...
			      <input type="date" name="entryTime1" class="" id="entryTime1" >
			      <input type="date" name="entryTime2" class="" id="entryTime2" >
					...
					<form id="form_user" method="post" action="reserveUser.htm">
						...
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							...
							<tr>
								<td>特点：</td>
								<td>
								<input type="checkbox" id="expressTrait1" name="expressTrait" value="骚"/>骚
								<input type="checkbox" id="expressTrait2" name="expressTrait" value="浪"/>浪
								<input type="checkbox" id="expressTrait3" name="expressTrait" value="贱"/>贱
								</td>
							</tr>
	...
	<div class="modal fade" id="modal_user_import" role="dialog" aria-labelledby="modal_user_edit" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-body">
					<form id="form_import" method="post"  enctype="multipart/form-date" action="importPerson.htm">
	...
	<div class="modal fade" id="modal_user_count" role="dialog" aria-labelledby="modal_user_del" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					 <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
					 <h4 class="modal-title" id="modal_user_del_head"> 公司人员信息  </h4>
				</div>
				<div class="modal-body">
	...
	var TableInit = function () {
	    ...
	    oTableInit.queryParams = function (params) {
	        var temp = {//这里的键的名字和控制器的变量名必须一致，这边改动，控制器也需要改成一样的
	            ...
	            entryTime1: $("#entryTime1").val(),
	            entryTime2: $("#entryTime2").val(),
	    	...
	    	$("#btn_count").click(function(){
	    		$.ajax({
	    		    ...
	    		    success:function(res){
	    		    	...
	    		    	var xdata=[];
	    		    	var ydata=[];
	    		    	res.data.forEach(function(zx){
						xdata.push(zx.cname);
						ydata.push({value: zx.num, name: zx.cname});
	...
	function initEditUser(getSelection){
		...
		$('#expressTrait1').prop("checked",getSelection.expressTrait.indexOf("骚")!=-1);
		$('#expressTrait2').prop("checked",getSelection.expressTrait.indexOf("浪")!=-1);
		$('#expressTrait3').prop("checked",getSelection.expressTrait.indexOf("贱")!=-1);
